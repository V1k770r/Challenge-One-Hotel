...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
	    ...
	    String textoDescripcion = "<html><body>Sistema de reserva de hotel. Controle y administre de forma óptima y fácil <br> " +
				"el flujo de reservas y de huespédes del hotel   </body></html>";
	    ...
	    String textoDescripcion1 = "<html><body> Esta herramienta le permitirá llevar un control completo y detallado de sus reservas " +
				"y huéspedes, tendrá acceso a heramientas especiales para tareas específicas como lo son:</body></html>";
